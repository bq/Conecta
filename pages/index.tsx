        ...
        <Row alignItems="stretch" mb={40}>
          ...
          <Column width={[1, 1 / 2]} mb={20}>
            <OptionPanel>
              ...
              <p>
                Selecciona esta opción para solicitar ayuda de algún voluntario.
                Puedes solicitar ayuda para ti o para otra persona. Deberás
                rellenar tus datos de contacto (o los de la otra persona) y el
                horario en el que necesitas ayuda.
                <strong>
                  <u>
